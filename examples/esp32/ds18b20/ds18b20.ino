...
DeviceAddress firstThermometer, secondThermometer, thirdThermometer;
...
void setup(void)
{
  ...
  if (!sensors.getAddress(thirdThermometer, 2)) Serial.println("Unable to find address for Device 1");
